...
import 'package:my_app/modules/Shop_App/shop_register/cubit/cubit.dart';
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<RegisterCubit, RegisterStates>(
        listener: (context, state) {
          ...
          if(state is DataRegisterSuccessState){
            if(cubit.registermodel?.status==true){
              NaviatAndPush(context, ShopLogInScreen());
              MessageShop(message: "${cubit.registermodel?.message}",BackgroundColor: Colors.green);
            }else{

              MessageShop(message: "${cubit.registermodel?.message}",BackgroundColor: Colors.red);
            }
